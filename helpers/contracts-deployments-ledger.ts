...
import { getLedgerSigner } from './contracts-helpers';
import {
...
export const deployUiPoolDataProvider = async (
  ...
  const instance = await deployContractWithLedger<UiPoolDataProvider>(id, args);
  if (verify) {
...
export const deployHaloUiPoolDataProvider = async (
  ...
  const instance = await deployContractWithLedger<UiHaloPoolDataProvider>(id, args);
  if (verify) {
    await verifyContract(id, instance, args);
  }
  return instance;
...
export const deployUiIncentiveDataProvider = async (verify?: boolean) => {
  ...
  const args: string[] = [];
  const instance = await deployContractWithLedger<UiIncentiveDataProvider>(id, args);
  if (verify) {
    await verifyContract(id, instance, args);
  }
  return instance;
...
export const deployLendingPoolAddressesProvider = async (marketId: string, verify?: boolean) =>
  withSaveAndVerify(
    await new LendingPoolAddressesProviderFactory(await getLedgerSigner()).deploy(marketId),
...
export const deployLendingPoolAddressesProviderRegistry = async (verify?: boolean) =>
  withSaveAndVerify(
    await new LendingPoolAddressesProviderRegistryFactory(await getLedgerSigner()).deploy(),
...
export const deployLendingPoolConfigurator = async (verify?: boolean) => {
  const lendingPoolConfiguratorImpl = await new LendingPoolConfiguratorFactory(await getLedgerSigner()).deploy();
...
export const deployReserveLogicLibrary = async (verify?: boolean) =>
  withSaveAndVerify(
    await new ReserveLogicFactory(await getLedgerSigner()).deploy(),
...
export const deployGenericLogic = async (reserveLogic: Contract, verify?: boolean) => {
  ...
  const genericLogic = await (await genericLogicFactory.connect(await getLedgerSigner()).deploy()).deployed();
...
export const deployValidationLogic = async (reserveLogic: Contract, genericLogic: Contract, verify?: boolean) => {
  ...
  const validationLogic = await (await validationLogicFactory.connect(await getLedgerSigner()).deploy()).deployed();
...
export const deployLendingPool = async (verify?: boolean) => {
  ...
  const lendingPoolImpl = await new LendingPoolFactory(libraries, await getLedgerSigner()).deploy();
...
export const deployPriceOracle = async (verify?: boolean) =>
  withSaveAndVerify(
    await new PriceOracleFactory(await getLedgerSigner()).deploy(),
...
export const deployLendingRateOracle = async (verify?: boolean) =>
  withSaveAndVerify(
    await new LendingRateOracleFactory(await getLedgerSigner()).deploy(),
...
export const deployMockAggregator = async (price: tStringTokenSmallUnits, verify?: boolean) =>
  withSaveAndVerify(
    await new MockAggregatorFactory(await getLedgerSigner()).deploy(price),
...
export const deployAaveOracle = async (
  ...
  withSaveAndVerify(
    await new AaveOracleFactory(await getLedgerSigner()).deploy(...args),
...
export const deployLendingPoolCollateralManager = async (verify?: boolean) => {
  const collateralManagerImpl = await new LendingPoolCollateralManagerFactory(await getLedgerSigner()).deploy();
...
export const deployInitializableAdminUpgradeabilityProxy = async (verify?: boolean) =>
  withSaveAndVerify(
    await new InitializableAdminUpgradeabilityProxyFactory(await getLedgerSigner()).deploy(),
...
export const deployMockFlashLoanReceiver = async (addressesProvider: tEthereumAddress, verify?: boolean) =>
  withSaveAndVerify(
    await new MockFlashLoanReceiverFactory(await getLedgerSigner()).deploy(addressesProvider),
...
export const deployWalletBalancerProvider = async (verify?: boolean) =>
  withSaveAndVerify(
    await new WalletBalanceProviderFactory(await getLedgerSigner()).deploy(),
...
export const deployAaveProtocolDataProvider = async (addressesProvider: tEthereumAddress, verify?: boolean) =>
  withSaveAndVerify(
    await new AaveProtocolDataProviderFactory(await getLedgerSigner()).deploy(addressesProvider),
...
export const deployMintableERC20 = async (args: [string, string, string], verify?: boolean): Promise<MintableERC20> =>
  withSaveAndVerify(
    await new MintableERC20Factory(await getLedgerSigner()).deploy(...args),
...
export const deployMintableDelegationERC20 = async (
  ...
  withSaveAndVerify(
    await new MintableDelegationERC20Factory(await getLedgerSigner()).deploy(...args),
...
export const deployDefaultReserveInterestRateStrategy = async (
  ...
  withSaveAndVerify(
    await new DefaultReserveInterestRateStrategyFactory(await getLedgerSigner()).deploy(...args),
...
export const deployStableDebtToken = async (
  ...
  const instance = await withSaveAndVerify(
    await new StableDebtTokenFactory(await getLedgerSigner()).deploy(),
...
export const deployVariableDebtToken = async (
  ...
  const instance = await withSaveAndVerify(
    await new VariableDebtTokenFactory(await getLedgerSigner()).deploy(),
...
export const deployGenericAToken = async (
  ...
  const instance = await withSaveAndVerify(
    await new ATokenFactory(await getLedgerSigner()).deploy(),
    eContractid.AToken,
    [],
    verify
  );
...
export const deployGenericATokenImpl = async (verify: boolean) =>
  withSaveAndVerify(await new ATokenFactory(await getLedgerSigner()).deploy(), eContractid.AToken, [], verify);
...
export const deployDelegationAwareAToken = async (
  ...
  const instance = await withSaveAndVerify(
    await new DelegationAwareATokenFactory(await getLedgerSigner()).deploy(),
...
export const deployStableAndVariableTokensHelper = async (
  ...
  withSaveAndVerify(
    await new StableAndVariableTokensHelperFactory(await getLedgerSigner()).deploy(...args),
...
export const deployATokensAndRatesHelper = async (
  ...
  withSaveAndVerify(
    await new ATokensAndRatesHelperFactory(await getLedgerSigner()).deploy(...args),
...
export const deployWETHGateway = async (args: [tEthereumAddress], verify?: boolean) =>
  withSaveAndVerify(
    await new WETHGatewayFactory(await getLedgerSigner()).deploy(...args),
...
export const authorizeWETHGateway = async (wethGateWay: tEthereumAddress, lendingPool: tEthereumAddress) =>
  await new WETHGatewayFactory(await getLedgerSigner()).attach(wethGateWay).authorizeLendingPool(lendingPool);
...
export const deployMockStableDebtToken = async (
  ...
  const instance = await withSaveAndVerify(
    await new MockStableDebtTokenFactory(await getLedgerSigner()).deploy(),
...
export const deployWETHMocked = async (verify?: boolean) =>
  withSaveAndVerify(await new WETH9MockedFactory(await getLedgerSigner()).deploy(), eContractid.WETHMocked, [], verify);
...
export const deployMockVariableDebtToken = async (
  ...
  const instance = await withSaveAndVerify(
    await new MockVariableDebtTokenFactory(await getLedgerSigner()).deploy(),
...
export const deployMockAToken = async (
  ...
  const instance = await withSaveAndVerify(
    await new MockATokenFactory(await getLedgerSigner()).deploy(),
...
export const deploySelfdestructTransferMock = async (verify?: boolean) =>
  withSaveAndVerify(
    await new SelfdestructTransferFactory(await getLedgerSigner()).deploy(),
...
export const deployMockUniswapRouter = async (verify?: boolean) =>
  withSaveAndVerify(
    await new MockUniswapV2Router02Factory(await getLedgerSigner()).deploy(),
...
export const deployUniswapLiquiditySwapAdapter = async (
  ...
  withSaveAndVerify(
    await new UniswapLiquiditySwapAdapterFactory(await getLedgerSigner()).deploy(...args),
...
export const deployUniswapRepayAdapter = async (
  ...
  withSaveAndVerify(
    await new UniswapRepayAdapterFactory(await getLedgerSigner()).deploy(...args),
...
export const deployFlashLiquidationAdapter = async (
  ...
  withSaveAndVerify(
    await new FlashLiquidationAdapterFactory(await getLedgerSigner()).deploy(...args),
...
export const deployMockParaSwapAugustus = async (verify?: boolean) =>
  withSaveAndVerify(
    await new MockParaSwapAugustusFactory(await getLedgerSigner()).deploy(),
...
export const deployMockParaSwapAugustusRegistry = async (args: [tEthereumAddress], verify?: boolean) =>
  withSaveAndVerify(
    await new MockParaSwapAugustusRegistryFactory(await getLedgerSigner()).deploy(...args),
...
export const deployParaSwapLiquiditySwapAdapter = async (
  ...
  withSaveAndVerify(
    await new ParaSwapLiquiditySwapAdapterFactory(await getLedgerSigner()).deploy(...args),
...
export const deployRnbwMock = async (args: [string, string], verify?: boolean) =>
  withSaveAndVerify(
    await new RnbwMockFactory(await getLedgerSigner()).deploy(...args),
...
export const deployUniswapV2Factory = async (args: [tEthereumAddress], verify?: boolean) =>
  withSaveAndVerify(
    await new UniswapV2FactoryFactory(await getLedgerSigner()).deploy(...args),
...
export const deployTreasury = async (
  ...
  withSaveAndVerify(
    await new TreasuryFactory(await getLedgerSigner()).deploy(...args),
...
export const deployVestingContractMock = async (args: [tEthereumAddress], verify?: boolean) =>
  withSaveAndVerify(
    await new VestingContractMockFactory(await getLedgerSigner()).deploy(...args),
...
export const deployMockEmissionManager = async (args: [], verify?: boolean) =>
  withSaveAndVerify(
    await new MockEmissionManagerFactory(await getLedgerSigner()).deploy(),
...
export const deployRnbwIncentivesContoller = async (
  ...
  withSaveAndVerify(
    await new RnbwIncentivesControllerFactory(await getLedgerSigner()).deploy(...args),
...
export const deployCurveMock = async (args: [tEthereumAddress, tEthereumAddress, string], verify?: boolean) =>
  withSaveAndVerify(
    await new CurveMockFactory(await getLedgerSigner()).deploy(...args),
...
export const deployCurveFactoryMock = async (
  ...
  withSaveAndVerify(
    await new CurveFactoryMockFactory(await getLedgerSigner()).deploy(...args),
