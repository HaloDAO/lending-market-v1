...
export const MOCK_CHAINLINK_AGGREGATORS_PRICES = {
  ...
  AMPL: oneEther.multipliedBy('0.00023421').toFixed(),
  ...
  HLP_GBP_USDC: oneEther.multipliedBy('0.00023421').toFixed(),
  RNBW: oneEther.multipliedBy('0.00023421').toFixed(),
  xRNBW: oneEther.multipliedBy('0.00023421').toFixed(),
};
