...
task(`external:uipoolprovider-checker`, `Check UI Pool Provider`).setAction(async ({ verify }, localBRE) => {
  ...
  const uiPoolDataProvider = await getHaloUiPoolDataProvider('0x977acfF7b2689Cf2919190627bd218EeF93795f6');
  ...
  console.log(
    ...
    uiPoolDataProvider.networkBaseTokenPriceInUsdProxyAggregator
  );
