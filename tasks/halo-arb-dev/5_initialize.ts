...
task('halo:arb-dev-initialize-5', 'Initialize lending pool configuration.')
  ...
  .setAction(async ({ verify }, localBRE) => {
    ...
    // console.log('reserveAssets', reserveAssets);
    // console.log(' HALO_CONTRACT_ADDRESSES[network]', HALO_CONTRACT_ADDRESSES[network]);
    ...
    console.log('initReservesByHelper', initReservesByHelper);
