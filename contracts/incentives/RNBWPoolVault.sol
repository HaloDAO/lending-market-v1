...
/**
 * @title RNBWPoolVault
 * @notice Stores all the xRNBW kept for incentives, just giving approval to the different
 * systems that will pull xRNBW funds for their specific use case. Base on the AAVE ecosystem reserve
 **/

contract RNBWPoolVault is VersionedInitializable {
